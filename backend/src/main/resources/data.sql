...
VALUES ('admin@almacen.com', 'Administrador', 'Sistema', '$2a$10$8K1p.yaHlheh5AcGo.vMw.wzNe1Tzsr8KE8gKg/.R9vuTsrQ3YIWS', 'ADMIN', true, CURRENT_TIMESTAMP);
-- Password: admin123
...
VALUES ('cliente@test.com', 'Juan', 'Pérez', '$2a$10$8K1p.yaHlheh5AcGo.vMw.wzNe1Tzsr8KE8gKg/.R9vuTsrQ3YIWS', 'CLIENTE', true, '555-1234', 'Calle Falsa 123, Ciudad', CURRENT_TIMESTAMP);
-- Password: admin123
