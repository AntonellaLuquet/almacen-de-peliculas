...
VALUES
('El Padrino', 'La historia de la familia Corleone bajo el patriarca Vito Corleone...', 'Francis Ford Coppola', 1972, 175, 'DRAMA', 'R', 19.99, 25, true, 'https://m.media-amazon.com/images/M/MV5BM2MyNjYxNmUtYTAwNi00MTYxLWJmNWYtYzZlODY3ZTk3OTFlXkEyXkFqcGdeQXVyNzkwMjQ5NzM@.jpg', 'https://example.com/padrino-trailer.mp4', CURRENT_TIMESTAMP),
('Pulp Fiction', 'Las vidas de dos sicarios de la mafia, un boxeador, un gángster y su esposa...', 'Quentin Tarantino', 1994, 154, 'THRILLER', 'R', 17.99, 30, true, 'https://image.tmdb.org/t/p/original/d5iIlFn5s0ImszYzBPb8JPIfbXD.jpg', 'https://example.com/pulp-trailer.mp4', CURRENT_TIMESTAMP),
('El Señor de los Anillos: La Comunidad del Anillo', 'Un hobbit de la Comarca y ocho compañeros se embarcan en un viaje...', 'Peter Jackson', 2001, 178, 'FANTASIA', 'PG_13', 22.99, 40, true, 'https://image.tmdb.org/t/p/original/6oom5QYQ2yQTMJIbnvbkBL9cHo6.jpg', 'https://example.com/lotr1-trailer.mp4', CURRENT_TIMESTAMP),
('Matrix', 'Un hacker informático aprende de misteriosos rebeldes sobre la verdadera naturaleza de su realidad...', 'The Wachowskis', 1999, 136, 'CIENCIA_FICCION', 'R', 16.99, 35, true, 'https://image.tmdb.org/t/p/original/f89U3ADr1oiB1s9GkdPOEpXUk5H.jpg', 'https://example.com/matrix-trailer.mp4', CURRENT_TIMESTAMP),
('Forrest Gump', 'Las presidencias de Kennedy y Johnson, los eventos de Vietnam, Watergate y otros eventos históricos...', 'Robert Zemeckis', 1994, 142, 'DRAMA', 'PG_13', 18.99, 20, true, 'https://m.media-amazon.com/images/M/MV5BNWIwODRlZTUtY2U3ZS00Yzg1LWJhNzYtMmZiYmEyNmU1NjMzXkEyXkFqcGdeQXVyMTQxNzMzNDI@.jpg', 'https://example.com/forrest-trailer.mp4', CURRENT_TIMESTAMP),
('El Rey León', 'El príncipe león Simba y su padre son atacados por su tío...', 'Roger Allers', 1994, 88, 'ANIMACION', 'G', 14.99, 50, true, 'https://image.tmdb.org/t/p/original/sKCr78MXSLixwmZ8DyJLrpMsd15.jpg', 'https://example.com/rey-leon-trailer.mp4', CURRENT_TIMESTAMP),
('Titanic', 'Un aristócrata de diecisiete años se enamora de un artista amable pero pobre...', 'James Cameron', 1997, 194, 'ROMANCE', 'PG_13', 21.99, 28, true, 'https://image.tmdb.org/t/p/original/9xjZS2rlVxm8SFx8kPC3aIGCOYQ.jpg', 'https://example.com/titanic-trailer.mp4', CURRENT_TIMESTAMP),
('Los Vengadores', 'Los superhéroes más poderosos de la Tierra deben unirse y aprender a luchar como un equipo...', 'Joss Whedon', 2012, 143, 'ACCION', 'PG_13', 19.99, 45, true, 'https://image.tmdb.org/t/p/original/RYMX2wcKCBAr24UyPD7xwmjaTn.jpg', 'https://example.com/vengadores-trailer.mp4', CURRENT_TIMESTAMP),
('La La Land', 'Mientras navegan por sus carreras en Los Ángeles, un pianista y una actriz se enamoran...', 'Damien Chazelle', 2016, 128, 'MUSICAL', 'PG_13', 16.99, 22, true, 'https://m.media-amazon.com/images/M/MV5BMzUzNDM2NzM2MV5BMl5BanBnXkFtZTgwNTM3NTg4OTE@.jpg', 'https://example.com/lalaland-trailer.mp4', CURRENT_TIMESTAMP),
('Jurassic Park', 'Un empresario pragmático y un equipo de científicos genéticos han creado un parque de atracciones...', 'Steven Spielberg', 1993, 127, 'AVENTURA', 'PG_13', 18.99, 32, true, 'https://m.media-amazon.com/images/M/MV5BMjM2MDgxMDg0Nl5BMl5BanBnXkFtZTgwNTM2OTM5NDE@.jpg', 'https://example.com/jurassic-trailer.mp4', CURRENT_TIMESTAMP);
