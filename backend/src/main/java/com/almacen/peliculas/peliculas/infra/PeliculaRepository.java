 ...
 * 
 * Proporciona operaciones CRUD y consultas personalizadas para la entidad Película.
 * Incluye métodos para búsqueda, filtrado por múltiples criterios y gestión de stock.
 * 
...
public interface PeliculaRepository extends JpaRepository<Pelicula, Long> {
    ...
    /**
     * Obtiene películas más populares (por ventas - implementar cuando tengamos pedidos)
